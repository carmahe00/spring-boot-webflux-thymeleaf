...
public class SpringBootWebfluxThymeleafApplication implements CommandLineRunner {
	@Autowired
	...
	private static final Logger log = LoggerFactory.getLogger(SpringBootWebfluxThymeleafApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(SpringBootWebfluxThymeleafApplication.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		.thenMany(Flux.just(new Producto("TV Panasonic Pantalla LCD", 456.89, electronico),
				...
				new Producto("TV Sony Bravia OLED 4K Ultra HD", 2255.89, electronico)).flatMap(producto -> {
